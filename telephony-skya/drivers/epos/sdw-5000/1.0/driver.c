#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"EPOS")==0&&strstr(d->model,"SDW 5000")!=0;}
...
static const skya_phone_driver driver={"c-epos_sdw_5000","EPOS",probe,capabilities};
