#include "driver.h"
#include <cstring>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&std::strcmp(d->vendor,"Grandstream")==0&&std::strstr(d->model,"GUV3005")!=nullptr;}
...
extern "C" const skya_phone_driver *skya_grandstream_guv3005_driver(void){return &driver;}
