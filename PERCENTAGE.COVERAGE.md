...
- emit target-specific instructions.
...
Every percentage requires a denominator. Examples:
...
function coverage     = recovered functions / eligible function regions
structure coverage    = parsed eligible structures / expected eligible structures
```
