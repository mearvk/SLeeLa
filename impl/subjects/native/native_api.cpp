...
bool isModuleAvailable(const std::string& module) {
    static const std::set<std::string> modules = {"math","physics","economics","inference","astrophysics","excel","json","crypto","net"};
