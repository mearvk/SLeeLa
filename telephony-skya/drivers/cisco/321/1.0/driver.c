#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Cisco")==0&&strstr(d->model,"321")!=0;}
...
static const skya_phone_driver driver={"c-cisco_321","Cisco",probe,capabilities};
const skya_phone_driver *skya_c_cisco_321_driver(void){return &driver;}
