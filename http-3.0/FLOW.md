...
| Application status | §7 | `http3_status_t` | `http3_envelope.h` |
...
```text
   ...
   http3_naming_intern_op("orders","calculate") -> 1
        │
        ▼  §5 build the compact envelope
   http3_envelope_init(env, service_id=1, op_id=1, request_id=1001,
                       flags=0, payload="20,22")
        │
        ▼  §5 pack to wire (textual OR binary)
   textual:  H3 3 0 1 1 1001 5:20,22
   binary :  03 01 00000001 00000001 00000000000003e9 00000005 32302c3232
        │
