#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Yealink")==0&&strstr(d->model,"UH46")!=0;}
...
static const skya_phone_driver driver={"c-yealink_uh46","Yealink",probe,capabilities};
const skya_phone_driver *skya_c_yealink_uh46_driver(void){return &driver;}
