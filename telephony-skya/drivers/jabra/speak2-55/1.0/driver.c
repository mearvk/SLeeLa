#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Jabra")==0&&strstr(d->model,"SPEAK2 55")!=0;}
...
static const skya_phone_driver driver={"c-jabra_speak2_55","Jabra",probe,capabilities};
const skya_phone_driver *skya_c_jabra_speak2_55_driver(void){return &driver;}
