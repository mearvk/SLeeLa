#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"EPOS")==0&&strstr(d->model,"IMPACT SC 200")!=0;}
...
static const skya_phone_driver driver={"c-epos_impact_sc200","EPOS",probe,capabilities};
const skya_phone_driver *skya_c_epos_impact_sc200_driver(void){return &driver;}
