#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Logitech")==0&&strstr(d->model,"H570e")!=0;}
...
static const skya_phone_driver driver={"c-logitech_h570e","Logitech",probe,capabilities};
const skya_phone_driver *skya_c_logitech_h570e_driver(void){return &driver;}
