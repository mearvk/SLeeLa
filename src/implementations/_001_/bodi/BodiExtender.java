...
public class BodiExtender
{
    ...
    public BodiExtender()
    {
        try
        {
            this.map002.put("implementations._001_.nordshrift.NordshriftStartup.<init>", new ReflectionItem(NordshriftDriver.class.getConstructor()));

            this.map001.put("implementations._001_.nordshrift.drivers.NordshriftDriver.<init>", new ReflectionItem(NordshriftDriver.class.getMethod("init")));
        }
