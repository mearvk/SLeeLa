#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Jabra")==0&&strstr(d->model,"Evolve3 75")!=0;}
...
static const skya_phone_driver driver={"c-jabra_evolve3_75","Jabra",probe,capabilities};
