...
Current families: Mathematics, Physics, Chemistry, Economics, Finance, Inference, Data Analytics, and Astrophysics.
...
The generic schema is subject-model.xsd. Astrophysics examples are in astrophysics/.
