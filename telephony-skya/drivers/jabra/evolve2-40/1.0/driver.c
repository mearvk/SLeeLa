#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Jabra")==0&&strstr(d->model,"Evolve2 40")!=0;}
...
static const skya_phone_driver driver={"c-jabra_evolve2_40","Jabra",probe,capabilities};
