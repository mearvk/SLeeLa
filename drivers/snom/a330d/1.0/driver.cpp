#include "driver.h"
#include <cstring>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&std::strcmp(d->vendor,"Snom")==0&&std::strstr(d->model,"A330D")!=nullptr;}
...
static const skya_phone_driver driver={"snom_a330d","Snom",probe,capabilities};
extern "C" const skya_phone_driver *skya_snom_a330d_driver(void){return &driver;}
