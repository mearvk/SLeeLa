#include "driver.h"
#include <cstring>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&std::strcmp(d->vendor,"Logitech")==0&&std::strstr(d->model,"H570e")!=nullptr;}
...
extern "C" const skya_phone_driver *skya_logitech_h570e_driver(void){return &driver;}
