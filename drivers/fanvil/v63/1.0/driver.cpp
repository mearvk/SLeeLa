#include "driver.h"
#include <cstring>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&std::strcmp(d->vendor,"Fanvil")==0&&std::strstr(d->model,"V63")!=nullptr;}
...
extern "C" const skya_phone_driver *skya_fanvil_v63_driver(void){return &driver;}
