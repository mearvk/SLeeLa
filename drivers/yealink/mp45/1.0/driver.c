#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Yealink")==0&&strstr(d->model,"MP45")!=0;}
...
static const skya_phone_driver driver={"c-yealink_mp45","Yealink",probe,capabilities};
