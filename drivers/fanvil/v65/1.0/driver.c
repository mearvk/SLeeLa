#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Fanvil")==0&&strstr(d->model,"V65")!=0;}
...
static const skya_phone_driver driver={"c-fanvil_v65","Fanvil",probe,capabilities};
const skya_phone_driver *skya_c_fanvil_v65_driver(void){return &driver;}
