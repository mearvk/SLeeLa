#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Poly")==0&&strstr(d->model,"Voyager 5200")!=0;}
...
static const skya_phone_driver driver={"c-poly_voyager_5200","Poly",probe,capabilities};
const skya_phone_driver *skya_c_poly_voyager_5200_driver(void){return &driver;}
