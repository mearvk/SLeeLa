...
static const char *VENDOR="snom"; static const char *MODEL="a330d";
...
const skya_phone_driver *skya_snom_a330d_driver(void){return &driver;}
const char *skya_snom_a330d_model(void){return MODEL;}
