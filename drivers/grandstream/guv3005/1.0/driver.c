#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Grandstream")==0&&strstr(d->model,"GUV3005")!=0;}
...
static const skya_phone_driver driver={"c-grandstream_guv3005","Grandstream",probe,capabilities};
