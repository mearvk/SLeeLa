#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Logitech")==0&&strstr(d->model,"Zone Wired 2")!=0;}
...
static const skya_phone_driver driver={"c-logitech_zone_wired_2","Logitech",probe,capabilities};
