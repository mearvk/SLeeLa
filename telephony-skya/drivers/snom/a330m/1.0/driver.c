#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Snom")==0&&strstr(d->model,"A330M")!=0;}
...
static const skya_phone_driver driver={"c-snom_a330m","Snom",probe,capabilities};
const skya_phone_driver *skya_c_snom_a330m_driver(void){return &driver;}
