#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Jabra")==0&&strstr(d->model,"SPEAK2 75")!=0;}
...
static const skya_phone_driver driver={"c-jabra_speak2_75","Jabra",probe,capabilities};
const skya_phone_driver *skya_c_jabra_speak2_75_driver(void){return &driver;}
