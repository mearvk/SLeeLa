#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Poly")==0&&strstr(d->model,"Savi 8200")!=0;}
...
static const skya_phone_driver driver={"c-poly_savi_8200","Poly",probe,capabilities};
const skya_phone_driver *skya_c_poly_savi_8200_driver(void){return &driver;}
