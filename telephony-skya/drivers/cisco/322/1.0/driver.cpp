#include "driver.h"
#include <cstring>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&std::strcmp(d->vendor,"Cisco")==0&&std::strstr(d->model,"322")!=nullptr;}
...
static const skya_phone_driver driver={"cisco_322","Cisco",probe,capabilities};
extern "C" const skya_phone_driver *skya_cisco_322_driver(void){return &driver;}
