#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Grandstream")==0&&strstr(d->model,"GRP26xx")!=0;}
...
static const skya_phone_driver driver={"c-grandstream_grp26xx","Grandstream",probe,capabilities};
const skya_phone_driver *skya_c_grandstream_grp26xx_driver(void){return &driver;}
