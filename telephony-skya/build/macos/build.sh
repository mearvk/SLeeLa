...
SRC="$ROOT/native"; OUT="$ROOT/build/macos"; ASSETS="$OUT/assets"; LOGO="$REPO_ROOT/images/skya-logo-blue.jpeg"
CXX="${CXX:-clang++}"; CXXFLAGS="${CXXFLAGS:--std=c++17 -O2 -Wall -Wextra -Wpedantic -pthread}"
