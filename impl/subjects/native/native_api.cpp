...
bool isModuleAvailable(const std::string& module) {
    static const std::set<std::string> modules = {"math","physics","economics","inference","excel","json","crypto","net"};
