#include "driver.h"
#include <cstring>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&std::strcmp(d->vendor,"Fanvil")==0&&std::strstr(d->model,"X210i-V2")!=nullptr;}
...
static const skya_phone_driver driver={"fanvil_x210i_v2","Fanvil",probe,capabilities};
extern "C" const skya_phone_driver *skya_fanvil_x210i_v2_driver(void){return &driver;}
