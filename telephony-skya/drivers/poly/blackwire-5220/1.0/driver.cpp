#include "driver.h"
#include <cstring>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&std::strcmp(d->vendor,"Poly")==0&&std::strstr(d->model,"Blackwire 5220")!=nullptr;}
...
extern "C" const skya_phone_driver *skya_poly_blackwire_5220_driver(void){return &driver;}
