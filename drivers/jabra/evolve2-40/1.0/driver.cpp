#include "driver.h"
#include <cstring>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&std::strcmp(d->vendor,"Jabra")==0&&std::strstr(d->model,"Evolve2 40")!=nullptr;}
...
extern "C" const skya_phone_driver *skya_jabra_evolve2_40_driver(void){return &driver;}
