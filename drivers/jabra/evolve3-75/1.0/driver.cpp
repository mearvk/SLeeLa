#include "driver.h"
#include <cstring>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&std::strcmp(d->vendor,"Jabra")==0&&std::strstr(d->model,"Evolve3 75")!=nullptr;}
...
extern "C" const skya_phone_driver *skya_jabra_evolve3_75_driver(void){return &driver;}
