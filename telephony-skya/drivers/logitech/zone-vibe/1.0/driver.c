#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Logitech")==0&&strstr(d->model,"Zone Vibe")!=0;}
...
static const skya_phone_driver driver={"c-logitech_zone_vibe","Logitech",probe,capabilities};
