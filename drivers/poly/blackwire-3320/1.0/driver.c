#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Poly")==0&&strstr(d->model,"Blackwire 3320")!=0;}
...
static const skya_phone_driver driver={"c-poly_blackwire_3320","Poly",probe,capabilities};
