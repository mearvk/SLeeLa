...
HTTP 1.0 establishes the common SLeeLa large-file DOWNLOAD contract for files over 50 MB. Resume state keeps SESSION-ID, DATETIME, FILE-ID, FILE-NAME, INDEX, OFFSET, and TOTAL-SIZE. FILE-ID identifies the transfer; INDEX identifies its segment; OFFSET permits byte-accurate continuation.
