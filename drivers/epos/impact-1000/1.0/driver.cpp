#include "driver.h"
#include <cstring>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&std::strcmp(d->vendor,"EPOS")==0&&std::strstr(d->model,"IMPACT 1000")!=nullptr;}
...
extern "C" const skya_phone_driver *skya_epos_impact_1000_driver(void){return &driver;}
