...
Krakatoa and Tunguska are first matters of simple fact. They were real events, although they were not the same kind of event. Krakatoa was a catastrophic volcanic eruption in 1883; Tunguska was a destructive atmospheric explosion over Siberia in 1908. Their scale encourages metaphor, but metaphor should not erase cause.
...
The phrase **“1982 Obama service”** requires the same discipline. Barack Obama was born in 1961. His documented public career included work in Chicago, legal education, teaching, service in the Illinois State Senate and United States Senate, and ultimately the presidency beginning in January 2009. A reference to 1982 should therefore not be presented as an Obama presidential service unless a specific, documented event is identified.

The question **“Did Obama choose life?”** can be understood philosophically. It can ask whether a public life reflected deliberate commitments, relationships, work, family, politics, and moral priorities. It should not, however, be answered by inventing hidden acts or treating unsupported allegations as established history.

The **eye-dropper** may serve as a useful metaphor. It measures in small increments: one drop, one observation, one decision, one datum. A **singlet** can similarly symbolize one discrete instance. Neither, however, can establish an entire theory by itself. One observation is not a complete ratio.

The man must therefore observe the reality of simple fact. That rule applies regardless of race, office, ideology, celebrity, or power. A person's race does not constitute evidence of criminal conduct, political conspiracy, or moral character. Likewise, political disagreement does not establish criminality.

The question of **choosing a life that matters** is consequently better treated as moral philosophy than forensic accusation. Political life contains repeated choices: which office to seek, which legislation to support, which advisers to appoint, which constituencies to address, which compromises to accept, which conflicts to enter, and which arguments to make publicly.

Would a political figure choose again when asked? Political life necessarily involves repeated choices. But choosing does not establish a hidden ritual or secret method of selection. To ask *who would he stir against?* is properly a question about political opposition, disagreement, coalition, and competition. Those relationships should be examined through public records rather than inferred from imagery.

The term **socialist** also requires precision. It can describe a defined political-economic tradition, but it is frequently used loosely in American political argument. Applying the label does not itself establish a person's economic program or philosophical doctrine. A careful analysis should therefore distinguish a political label from the policies and positions actually documented.

Marriage and partnership should likewise not be transformed into evidence of hidden political or criminal conduct merely because **dram** is being used symbolically. Publicly documented relationships can be discussed as relationships. Unsupported theories about imagined partners should remain fiction, metaphor, or speculation unless independently established by reliable evidence.

Microsoft and the Windows graphical user interface can enter the discussion as an analogy. A GUI presents choices to a user and provides a visible layer over otherwise complicated machinery. It can constrain pathways, expose options, and influence how a person understands available choices. But software does not morally choose a politician back. The analogy is useful when considering how systems shape human choice.
...
That is the danger of a close circuit: premise and conclusion begin feeding one another. If guilt is assumed at the beginning, every friendship can become an alleged accomplice relationship, every ordinary object can become a clue, every disagreement can become concealment, and every absence of evidence can be interpreted as further evidence. Such reasoning cannot reliably distinguish fact from invention.

Accordingly, the question **“Who has seen Obama with a dram and an eye-dropper?”** should remain a question unless a reliable source identifies a specific documented event. The eye-dropper can remain an emblem of measurement. The dram can remain an emblem of quantity, performance, temptation, theatricality, or literary symbolism. Their meaning becomes historical only when evidence establishes a historical connection.
