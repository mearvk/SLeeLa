#include "driver.h"
#include <string.h>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&strcmp(d->vendor,"Grandstream")==0&&strstr(d->model,"GXP21xx")!=0;}
...
static const skya_phone_driver driver={"c-grandstream_gxp21xx","Grandstream",probe,capabilities};
