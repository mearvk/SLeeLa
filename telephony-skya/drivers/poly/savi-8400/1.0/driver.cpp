#include "driver.h"
#include <cstring>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&std::strcmp(d->vendor,"Poly")==0&&std::strstr(d->model,"Savi 8400")!=nullptr;}
...
extern "C" const skya_phone_driver *skya_poly_savi_8400_driver(void){return &driver;}
