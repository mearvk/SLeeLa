#include "driver.h"
#include <cstring>
static int probe(const skya_driver_device*d){return d&&d->vendor&&d->model&&std::strcmp(d->vendor,"Yealink")==0&&std::strstr(d->model,"MP45")!=nullptr;}
...
extern "C" const skya_phone_driver *skya_yealink_mp45_driver(void){return &driver;}
